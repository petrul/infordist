...
#DBG_OPTS="-Xdebug -Xrunjdwp:transport=dt_socket,server=y,suspend=n,address=1044"

java -Xmx7400m $JMX_OPTS $DBG_OPTS -Dfile.encoding=UTF-8 -classpath $CP inform.dist.cli.OrderNgdMatrixAndGetNeighbors $*
