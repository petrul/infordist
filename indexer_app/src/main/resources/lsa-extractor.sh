...
CP=$CP:$M2_REPO/pertinence/indexer_app/1.0/indexer_app-1.0.jar
...
CP=$CP:$M2_REPO/org/apache/lucene/lucene-analyzers/2.4.1/lucene-analyzers-2.4.1.jar
CP=$CP:$M2_REPO/org/apache/lucene/lucene-snowball/2.4.1/lucene-snowball-2.4.1.jar
CP=$CP:$M2_REPO/org/apache/lucene/lucene-core/2.4.1/lucene-core-2.4.1.jar
CP=$CP:$M2_REPO/org/apache/lucene/lucene-wikipedia/2.4.1/lucene-wikipedia-2.4.1.jar
CP=$CP:$M2_REPO/org/apache/lucene/lucene-benchmark/2.4.1/lucene-benchmark-2.4.1.jar
...
JMX_OPTS="-Dcom.sun.management.jmxremote -Dcom.sun.management.jmxremote.port=1111 -Dcom.sun.management.jmxremote.authenticate=false -Dcom.sun.management.jmxremote.ssl=false"

java -Xmx7400m $JMX_OPTS -Dfile.encoding=UTF-8 -classpath $CP inform.dist.lsa.LsaExtractor $*
