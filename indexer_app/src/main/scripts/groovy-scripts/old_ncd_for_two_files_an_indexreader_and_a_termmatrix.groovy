 ...
 *
 * but it does so in the presence of an IndexReader (why?) and stores the result in a termmatrix.
 * it also passes the filenames as terms through the analyzer.
 * so I must have had something in mind at the time but for now this is museum code hence the prefix old.
 */
