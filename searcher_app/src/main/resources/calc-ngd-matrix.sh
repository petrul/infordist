...
CP=$CP:$M2_REPO/pertinence/searcher_app/0.9/searcher_app-0.9.jar
...
java -Xmx7000m -Dfile.encoding=UTF-8 -classpath $CP inform.dist.cli.CalculateNgdMatrixFromPositionalIndex $*
