...
CP=$CP:$M2_REPO/pertinence/indexer_app/0.9/indexer_app-0.9.jar
CP=$CP:$M2_REPO/pertinence/gridgain_wrapper/0.9/gridgain_wrapper-0.9.jar

# gridgain stuff
CP=$CP:$M2_REPO/org/gridgain/gridgain/2.1.1/gridgain-2.1.1.jar
CP=$CP:$M2_REPO/concurrent/concurrent/1.3.4/concurrent-1.3.4.jar
CP=$CP:$M2_REPO/javassist/javassist/3.6/javassist-3.6.jar
CP=$CP:$M2_REPO/jboss/jboss-serialization/1.0.3.GA/jboss-serialization-1.0.3.GA.jar
CP=$CP:$M2_REPO/trove/trove/1.0.2/trove-1.0.2.jar
CP=$CP:$M2_REPO/jtidy/jtidy/4aug2000r7-dev/jtidy-4aug2000r7-dev.jar

CP=$CP:$M2_REPO/org/springframework/spring/2.5.6/spring-2.5.6.jar
CP=$CP:$M2_REPO/org/springframework/spring-aop/2.5.6/spring-aop-2.5.6.jar
...
CP=$CP:$M2_REPO/commons-compress/commons-compress/1.0/commons-compress-1.0.jar
...
java -Xmx7000m  $JMX_OPTS -Dfile.encoding=UTF-8 -classpath $CP infordist.gg.CombinedComplexityJobManager $*
